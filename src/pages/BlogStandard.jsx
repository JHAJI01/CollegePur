...
import { Eye, MessageCircle, Calendar, ArrowRight, Play, Mail, Phone } from "lucide-react";
                ...
                <div className="blog-standard">
                  ...
                  <div className="single-blog-standard mb-30">
                    <div className="blog-standard-thumb">
                      <img src="https://images.unsplash.com/photo-1557804506-669a67965ba0?w=800&auto=format&fit=crop&q=60" alt="blog" className="w-full rounded-lg h-[400px] object-cover" />
                    </div>
                    <div className="blog-standard-content mt-8">
                      <a href="#" className="cat text-blue-600 font-medium">Business</a>
                      <h2 className="title text-2xl font-bold mt-2 mb-4">Strategic Planning: Key to Business Growth and Success</h2>
                      <ul className="post-meta flex space-x-6 text-sm text-gray-500 mb-4">
                        <li className="flex items-center"><Eye className="w-4 h-4 mr-2" /> 189 Views</li>
                        <li className="flex items-center"><MessageCircle className="w-4 h-4 mr-2" /> 28 Comments</li>
                        <li className="flex items-center"><Calendar className="w-4 h-4 mr-2" /> 25th March 2019</li>
                      </ul>
                      <p className="text-gray-600 mb-6">Strategic planning is essential for any business looking to grow and succeed in today's competitive market. It involves setting clear goals, analyzing market trends, and developing actionable strategies to achieve long-term success. This comprehensive approach helps businesses stay focused and make informed decisions.</p>
                      <div className="blog-standard-footer flex justify-between items-center">
                        <div className="footer-left flex items-center">
                          <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&auto=format&fit=crop&q=60" alt="" className="w-10 h-10 rounded-full mr-3 object-cover" />
                          <a href="#" className="text-gray-700"><span className="text-gray-500">by</span> John Smith</a>
                        </div>
                        <div className="footer-right">
                          <a href="#" className="text-blue-600 flex items-center hover:text-blue-700">
                            Read More <ArrowRight className="w-4 h-4 ml-2" />
                  ...
                  <div className="single-blog-standard mb-30">
                    <div className="blog-standard-thumb">
                      <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&auto=format&fit=crop&q=60" alt="blog" className="w-full rounded-lg h-[400px] object-cover" />
                    </div>
                    <div className="blog-standard-content mt-8">
                      <a href="#" className="cat text-blue-600 font-medium">Business</a>
                      <h2 className="title text-2xl font-bold mt-2 mb-4">Digital Transformation: Reshaping Modern Business</h2>
                      <ul className="post-meta flex space-x-6 text-sm text-gray-500 mb-4">
                        <li className="flex items-center"><Eye className="w-4 h-4 mr-2" /> 245 Views</li>
                        <li className="flex items-center"><MessageCircle className="w-4 h-4 mr-2" /> 42 Comments</li>
                        <li className="flex items-center"><Calendar className="w-4 h-4 mr-2" /> 26th March 2019</li>
                      </ul>
                      <p className="text-gray-600 mb-6">Digital transformation is revolutionizing how businesses operate and compete in the modern marketplace. From cloud computing to artificial intelligence, companies are leveraging technology to streamline operations, enhance customer experiences, and drive innovation. This shift is essential for staying relevant in today's fast-paced business environment.</p>
                      <div className="blog-standard-footer flex justify-between items-center">
                        <div className="footer-left flex items-center">
                          <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&auto=format&fit=crop&q=60" alt="" className="w-10 h-10 rounded-full mr-3 object-cover" />
                          <a href="#" className="text-gray-700"><span className="text-gray-500">by</span> Sarah Johnson</a>
                        </div>
                        <div className="footer-right">
                          <a href="#" className="text-blue-600 flex items-center hover:text-blue-700">
                            Read More <ArrowRight className="w-4 h-4 ml-2" />
                ...
                <div className="blog-sidebar">
                  ...
                  <div className="widget about-widget border-2 border-[#ededed] p-[35px_40px] mb-[30px]">
                    ...
                    <div className="about-content text-center">
                      ...
                      <ul className="flex justify-center space-x-4">
                        <li>
                          <a href="#" className="text-[#616161] hover:text-red-600 transition-colors duration-300">
                  ...
                  <div className="widget search-widget border-2 border-[#ededed] p-[35px_40px] mb-[30px]">
                    ...
                    <form className="relative">
                      ...
                      />
                      <button 
                        className="absolute right-0 top-0 bottom-0 w-[60px] text-center border-0 bg-[#0c59db] text-white transition-all duration-300 ease-out flex items-center justify-center"
                        style={{
                          overflow: 'visible',
                          margin: 0,
                          fontFamily: 'inherit',
                  ...
                  {/* Categories Widget */}
                  <div className="widget categories-widget border-2 border-[#ededed] p-[35px_40px] mb-[30px] [&::-webkit-scrollbar]:bg-[#ccc] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar]:h-1 [&::-webkit-scrollbar-thumb]:bg-[#002249]">
                    ...
                    <ul className="space-y-2 font-['Karla']">
                      <li><a href="#" className="w-full bg-[#152136] h-[50px] leading-[50px] pl-[30px] text-white text-[14px] relative flex justify-between items-center pr-[30px] hover:text-red-600 transition-all duration-300">Business<span>26</span></a></li>
                      <li><a href="#" className="w-full bg-[#152136] h-[50px] leading-[50px] pl-[30px] text-white text-[14px] relative flex justify-between items-center pr-[30px] hover:text-red-600 transition-all duration-300">Consultant<span>30</span></a></li>
                      <li><a href="#" className="w-full bg-[#152136] h-[50px] leading-[50px] pl-[30px] text-white text-[14px] relative flex justify-between items-center pr-[30px] hover:text-red-600 transition-all duration-300">Creative<span>71</span></a></li>
                      <li><a href="#" className="w-full bg-[#152136] h-[50px] leading-[50px] pl-[30px] text-white text-[14px] relative flex justify-between items-center pr-[30px] hover:text-red-600 transition-all duration-300">UI/UX<span>56</span></a></li>
                      <li><a href="#" className="w-full bg-[#152136] h-[50px] leading-[50px] pl-[30px] text-white text-[14px] relative flex justify-between items-center pr-[30px] hover:text-red-600 transition-all duration-300">Technology<span>60</span></a></li>
                    </ul>
                  </div>
                  ...
                  <div className="widget twitter-feed-widget border-2 border-[#ededed] p-[35px_40px] mb-[30px]">
                    <h4 className="widget-title text-[20px] pl-10 relative mb-[30px] font-bold text-[#002249] gilroy-bold before:content-[''] before:absolute before:h-1 before:w-1 before:left-[21px] before:top-3 before:bg-[#0c59db] after:content-[''] after:absolute after:h-1 after:w-[18px] after:left-0 after:top-3 after:bg-[#0c59db]">Twitter Feeds</h4>
                    <div className="twitter-feeds space-y-6 font-['Karla']">
                      <div className="twitter-feed-item relative pl-8">
                        <i className="fab fa-twitter absolute top-[7px] left-0 text-[#32beff]"></i>
                        <ul className="space-y-1">
                          <li><a href="#" className="text-[12px] leading-6 text-[#0c59db] hover:text-red-600 transition-all duration-300">Rescue - #Gutenberg ready @ wordpress</a></li>
                          <li><a href="#" className="text-[12px] leading-6 text-[#0c59db] hover:text-red-600 transition-all duration-300">Theme for Creative Bloggers available on</a></li>
                          <li><a href="#" className="text-[12px] leading-6 text-[#0c59db] hover:text-red-600 transition-all duration-300">@ ThemeForest https://t.co/2r1POjOjgV</a></li>
                          <li><a href="#" className="text-[12px] leading-6 text-[#0c59db] hover:text-red-600 transition-all duration-300">C… https://t.co/rDAnPyClu1</a></li>
                        </ul>
                        <div className="mt-2">
                          <span className="text-sm text-[#616161]">November 25, 2018</span>
                        </div>
                      </div>
                      <div className="twitter-feed-item relative pl-8">
                        <i className="fab fa-twitter absolute top-[7px] left-0 text-[#32beff]"></i>
